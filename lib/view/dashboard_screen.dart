...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  final List<Map<String, dynamic>> categories = [
    {"icon": Icons.edit, "label": "Pens", "color": Colors.blue},
    {"icon": Icons.book, "label": "Notebooks", "color": Colors.amber},
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: ListView(
          children: const [
            ...
            ListTile(
              ...
              title: Text("Logout"),
              // NOTE: Navigation disabled in this branch (as per rule)
            ),
          ],
        ),
      ),
      appBar: AppBar(
        ...
        title: Row(
          children: [
            Image.asset('assets/images/KalamKart_logo.png', height: 38),
